#!/bin/bash
#SBATCH --job-name=train_v1_gptbert_lr_seed
#SBATCH --nodes=1
...
if [ $# -lt 2 ]; then
    ...
    echo "  train_bin defaults to the plain un-ablated corpus; pass the"
...
python train_v1.py \
    ...
    --name=gptbert_babycosmofine_short${DATA_NAME}_lr_${LEARNING_RATE}_seed_${SEED} \
    --hybrid_numerator=1 \
